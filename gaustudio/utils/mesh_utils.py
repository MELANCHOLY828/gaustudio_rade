...
class GaussianExtractor(object):
    ...
    def reconstruction(self, viewpoint_stack):
        ...
        for i, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="reconstruct radiance fields"):
            ...
            alpha =  render_pkg["rendered_final_opacity"][0]
            # depth = render_pkg["rendered_median_depth"][0].unsqueeze(0)
            depth = render_pkg["rendered_median_depth_rade"][0].unsqueeze(0)
            # depth = render_pkg["rendered_depth"][0].unsqueeze(0)
