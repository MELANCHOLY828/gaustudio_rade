...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    ...
    #     cov3D_precomp = cov3D_precomp
    # )    
    rendered_image, radii, rendered_depth, rendered_median_depth, rendered_depth_rade, rendered_median_depth_rade,rendered_final_opacity = rasterizer(
        means3D = means3D,
        means2D = means2D,
        shs = shs,
        colors_precomp = colors_precomp,
    ...
    return {"render": rendered_image,
            ...
            "rendered_final_opacity": rendered_final_opacity,
            "radii": radii,
            "rendered_depth_rade":rendered_depth_rade,
            "rendered_median_depth_rade":rendered_median_depth_rade}
